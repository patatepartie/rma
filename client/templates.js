(function (root, factory) {
    ...
    templatizer["includes"]["timeControl"] = function tmpl_includes_timeControl() {
        return '<aside data-hook="time-control"><section data-hook="times" class="row"><div data-hook="start-time" class="col-xs-offset-1 col-xs-2 text-left"></div><div data-hook="current-time" class="col-xs-offset-2 col-xs-2 text-center"></div><div data-hook="end-time" class="col-xs-offset-2 col-xs-2 text-right"></div></section><section data-hook="progress" class="row"><div class="form-group col-xs-offset-1 col-xs-10"><input type="range" data-hook="seek-bar"/></div></section><section data-hook="controls" class="form-inline"><div class="btn-toolbar"></div><div class="btn-group"><button type="button" data-hook="step-backward" class="btn btn-default"><span class="glyphicon glyphicon-step-backward"></span></button><button type="button" data-hook="play-pause" class="btn btn-default"><span class="glyphicon glyphicon-play"></span></button><button type="button" data-hook="step-forward" class="btn btn-default"><span class="glyphicon glyphicon-step-forward"></span></button></div><div class="btn-group"><button type="button" data-hook="decrease-speed" class="btn btn-default"><span class="glyphicon glyphicon-minus"></span></button><button type="button" data-hook="increase-speed" class="btn btn-default"><span class="glyphicon glyphicon-plus"></span></button></div></section></aside>';
    };
